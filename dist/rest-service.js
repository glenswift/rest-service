...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parse = function _parse(uri) {
	  var parts = uri.split('/');
	  var parsed = [];
	...
	var Service = (function () {
	  function Service(endpoint, methods, serviceConf) {
	    ...
	    for (var _name in methods) {
	      if (methods.hasOwnProperty(_name)) {
	        this[_name] = this.req.bind(this, methods[_name]);
	      }
	    }
	  }
	  ...
	  _createClass(Service, [{
	    key: 'req',
	    value: function req(conf) {
	      var params = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
	      var body = arguments.length <= 2 || arguments[2] === undefined ? {} : arguments[2];

	      var endpoint = this.parsedEndpoint.map(function (part) {
	        if (part.param) {
	      ...
	      endpoint = this.serviceConf.url + endpoint.filter(function (part) {
	        return part.length;
	      }).join('/');
	      ...
	      return new Promise(function (resolve, reject) {
	        var reqMethod = conf.method.toLowerCase() || 'get';
	        var payload = reqMethod !== 'get' ? body : null;
	        var query = reqMethod === 'get' ? body : null;
	        request[reqMethod](endpoint).set('Accept', 'application/json').query(query).send(payload).end(function (err, res) {
	          if (err) {
	            return reject(err);
	          }
	...
	var Base = (function () {
	  ...
	  _createClass(Base, [{
	    key: 'service',
	    value: function service(endpoint, methods) {
